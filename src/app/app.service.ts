    ...
    constructor(private http: Http) {
        this.getOrders = () => {
            return new DataSource({
                ...
                insert: (values) => {
                    return http.post(this.itemsURL, values)
                        .toPromise();
                },
                remove: (key) => {
                    return http.delete(this.itemsURL + encodeURIComponent(key))
                        .toPromise();
                },
                update: (key, values) => {
                    return http.put(this.itemsURL + encodeURIComponent(key), values)
                        .toPromise();
                }
            });
        }
